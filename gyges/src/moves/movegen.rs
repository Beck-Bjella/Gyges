...
type StackData = (Action, BitBoard, BitBoard, usize, usize, usize, usize, usize, Player);
...
pub unsafe fn valid_moves(board: &mut BoardState, player: Player) -> RawMoveList {
    ...
    let active_line = active_lines[player as usize] * 6;
    ...
    for x in 0..6 {
        if board.data[active_line + x] != 0 {
            ...
            STACK_BUFFER.push((Action::End, EMPTY, EMPTY, 0, 0, starting_piece, starting_piece_type, 0, player));
            STACK_BUFFER.push((Action::Gen, EMPTY, EMPTY, starting_piece, starting_piece_type, starting_piece, starting_piece_type, x, player));
            STACK_BUFFER.push((Action::Start, EMPTY, EMPTY, 0, 0, starting_piece, starting_piece_type, 0, player));
