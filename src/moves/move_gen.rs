...
pub unsafe fn old_valid_moves(board: &mut BoardState, player: f64) -> RawMoveList {
    let active_lines = board.get_active_lines();
    let mut move_list: RawMoveList = RawMoveList::new(board.get_drops(active_lines, player));
...
pub unsafe fn old_valid_move_count(board: &mut BoardState, player: f64) -> usize {
    let mut count = 0;
...
pub unsafe fn old_valid_threat_count(board: &mut BoardState, player: f64) -> usize {
    let mut count = 0;
